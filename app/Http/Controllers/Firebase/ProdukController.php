...
class ProdukController extends Controller
{
    ...
    function tambahProduk(Request $request) {
        ...
        foreach ($request->file('foto_produk') as $foto) {
            ...
            $url = 'https://storage.googleapis.com/sascode-aa3b7.appspot.com/' . $filename;
            $fotoUrl[] = $url;
        }
        ...
        foreach ($request->varian['nama'] as $i => $namaVarian) {
            ...
            $urlGambarVarian = 'https://storage.googleapis.com/sascode-aa3b7.appspot.com/' . $gambarFilename;
