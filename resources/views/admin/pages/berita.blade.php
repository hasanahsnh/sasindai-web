                                      ...
                                      <div class="card-body">
                                        ...
                                        <form class="forms-sample" id="formEdit{{ $key }}" action="{{ route('update-berita', ['id' => $key]) }}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                              <input type="text" style="border: 2px solid #8D0B41; border-radius: 4px;" class="form-control" value="{{ $item['judulArtikel'] }}" id="judul_artikel" name="judul_artikel" placeholder="Judul artikel" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Jurnalis</label>
                                            <div class="col-sm-9">
                                              <input type="text" style="border: 2px solid #8D0B41; border-radius: 4px;" class="form-control" value="{{ $item['jurnalis'] }}" id="jurnalis" name="jurnalis" placeholder="Jurnalis" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Konten Berita</label>
                                            <div class="col-sm-9">
                                              <textarea class="form-control" style="border: 2px solid #8D0B41; border-radius: 4px;" id="konten_berita" name="konten_berita" placeholder="Konten berita" required>{{ $item['kontenBerita'] }}</textarea>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Tanggal Terbit</label>
                                            <div class="col-sm-9">
                                              <input type="date" style="border: 2px solid #8D0B41; border-radius: 4px;" class="form-control" value="{{ $item['tanggalTerbit'] }}" id="tanggal_terbit" name="tanggal_terbit" placeholder="Masukkan tanggal terbit" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputMobile" class="col-sm-3 col-form-label">Foto Berita</label>
                                            <div class="col-sm-9">
                                              <input type="file" style="border: 2px solid #8D0B41; border-radius: 4px;" class="form-control" value="{{ $item['fotoBeritaUrl'] }}" id="foto_berita" name="foto_berita" placeholder="Pilih foto">
                                            </div>
                                          </div>
                              ...
                              <div class="modal-content rounded-0">
                                <div class="modal-body p-4 px-5">
                                  ...
                                  <div class="main-content text-center">
                                      ...
                                      <div class="card-body">
                                        <h4 class="card-title">Berita {{ $item['judulArtikel'] }}</h4>
                                        <form class="forms-sample" id="formEdit{{ $key }}" action="" method="">
                                          @csrf
                                          <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Judul Artikel</label>
                                            <div class="col-sm-9">
                                              <input type="text" class="form-control" value="{{ $item['judulArtikel'] }}" id="judul_artikel" name="judul_artikel" placeholder="Judul artikel" readonly>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Jurnalis</label>
                                            <div class="col-sm-9">
                                              <input type="text" class="form-control" value="{{ $item['jurnalis'] }}" id="jurnalis" name="jurnalis" placeholder="Jurnalis" readonly>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Konten Berita</label>
                                            <div class="col-sm-9">
                                              <textarea class="form-control" id="konten_berita" name="konten_berita" placeholder="Konten berita" readonly>{{ $item['kontenBerita'] }}</textarea>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Tanggal Terbit</label>
                                            <div class="col-sm-9">
                                              <input type="date" class="form-control" value="{{ $item['tanggalTerbit'] }}" id="tanggal_terbit" name="tanggal_terbit" placeholder="Masukkan tanggal terbit" readonly>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputMobile" class="col-sm-3 col-form-label">Foto Berita</label>
                                            <div class="col-sm-9">
                                              <img src="{{ $item['fotoBeritaUrl'] }}" alt="Preview Foto Berita" style="max-width: 100%; height: auto; margin-bottom: 10px;">
                                            </div>
                                          </div>
                            ...
                            <div class="card-body">
                              ...
                              <form class="forms-sample" id="formTambah" action="{{ url('simpan-berita') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                  <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Judul Artikel</label>
                                  <div class="col-sm-9">
                                    <input type="text" style="border: 2px solid #8D0B41; border-radius: 4px;" class="form-control" id="judul_artikel" name="judul_artikel" placeholder="Judul artikel" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Jurnalis</label>
                                  <div class="col-sm-9">
                                    <input type="text" style="border: 2px solid #8D0B41; border-radius: 4px;" class="form-control" id="jurnalis" name="jurnalis" placeholder="Jurnalis" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Konten Berita</label>
                                  <div class="col-sm-9">
                                    <textarea class="form-control" style="border: 2px solid #8D0B41; border-radius: 4px;" id="konten_berita" name="konten_berita" rows="4" placeholder="Konten berita" required></textarea>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Tanggal Terbit</label>
                                  <div class="col-sm-9">
                                    <input type="date" style="border: 2px solid #8D0B41; border-radius: 4px;" class="form-control" id="tanggal_terbit" name="tanggal_terbit" placeholder="Masukkan tanggal terbit" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputMobile" class="col-sm-3 col-form-label">Foto Berita</label>
                                  <div class="col-sm-9">
                                    <input type="file" style="border: 2px solid #8D0B41; border-radius: 4px;" class="form-control" id="foto_berita" name="foto_berita" placeholder="Pilih Foto" required>
                                  </div>
                                </div>
